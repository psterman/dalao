...
public final class EngineItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static EngineItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EngineItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.engine_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EngineItemBinding bind(@NonNull View rootView) {
